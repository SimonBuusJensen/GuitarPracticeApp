...
class PracticeActivity : AppCompatActivity() {
    ...
    private val chordStringToChordSound : HashMap<String, Int> = Utils.createChordStringToChordSoundHashMap()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        chordImageView.setOnClickListener {
            val chordMediaPlayer : MediaPlayer = MediaPlayer.create(this, chordStringToChordSound.get(currentDisplayedChord)!!)
            chordMediaPlayer.start()
        }
